...
var Alert = React17.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
  ...
  const alert = (0, import_jsx_runtime13.jsxs)("div", {
    role: "alert",
  ...
  return (0, import_jsx_runtime12.jsx)(Transition2, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
var BreadcrumbItem = React19.forwardRef(({
  ...
  return (0, import_jsx_runtime15.jsx)(Component2, {
    ...
    children: active ? children : (0, import_jsx_runtime15.jsx)(LinkComponent, {
      ...linkProps,
      href,
      title,
      target,
...
var Breadcrumb = React20.forwardRef(({
  ...
  return (0, import_jsx_runtime16.jsx)(Component2, {
    ...
    ref,
    ...props,
    children: (0, import_jsx_runtime16.jsx)("ol", {
      ...listProps,
...
function map(children, func) {
  let index = 0;
  return React24.Children.map(children, (child) => React24.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React24.Children.toArray(children).some((child) => React24.isValidElement(child) && child.type === type);
}
...
var Carousel = React25.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime20.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime20.jsx)("span", {
      "aria-hidden": "true",
  ...
  return (0, import_jsx_runtime21.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    onKeyDown: handleKeyDown,
    ...
    children: [indicators && (0, import_jsx_runtime20.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime20.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime20.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React25.cloneElement(child, {
            ...innerProps,
        ...
        }) : React25.cloneElement(child, {
          className: (0, import_classnames17.default)(child.props.className, isActive && "active")
        });
      })
    }), controls && (0, import_jsx_runtime21.jsxs)(import_jsx_runtime22.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime21.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime20.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime21.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime20.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
var DropdownContext = React27.createContext(null);
...
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  ...
  let [isSSR, setIsSSR] = (0, import_react38.useState)(true);
...
function DropdownToggle({
  ...
  return (0, import_jsx_runtime27.jsx)(import_jsx_runtime26.Fragment, {
    children: children(props, meta)
  });
}
...
var SelectableContext = React30.createContext(null);
...
var NavContext = React31.createContext(null);
...
var DropdownItem = React32.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
  ...
  return (0, import_jsx_runtime28.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  const context5 = (0, import_react42.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var DropdownContext2 = React34.createContext({});
...
var DropdownItem2 = React35.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownMenu2 = React38.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React39.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React40.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime33.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime33.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime33.jsx)(Component2, {
        ...props,
        ref,
...
var DropdownButton = React41.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime35.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime34.jsx)(DropdownToggle_default2, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime34.jsx)(DropdownMenu_default2, {
    role: menuRole,
...
var Feedback = React42.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime36.jsx)(Component2, {
    ...props,
    ref,
...
var FormContext = React43.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime37 = __toESM(require_jsx_runtime());
var FormCheckInput = React44.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React45.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
  ...
  return (0, import_jsx_runtime38.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React46.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const input = (0, import_jsx_runtime39.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime39.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime39.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime41.jsxs)(import_jsx_runtime40.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime39.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime39.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormGroup = React48.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
}, ref) => {
  const context5 = (0, import_react51.useMemo)(() => ({
    controlId
  }), [controlId]);
  return (0, import_jsx_runtime43.jsx)(FormContext_default.Provider, {
    value: context5,
    children: (0, import_jsx_runtime43.jsx)(Component2, {
      ...props,
      ref
    })
  });
...
var FormLabel = React49.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime44.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime44.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React50.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
  ...
  return (0, import_jsx_runtime45.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React51.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime46.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var FormText = React52.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React53.forwardRef((props, ref) => (0, import_jsx_runtime48.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React54.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  return (0, import_jsx_runtime50.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames32.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime49.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Container = React56.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var propTypes5 = {
   ...
   */
  rounded: import_prop_types8.default.bool,
  /**
   * Sets image shape as circle.
   */
  roundedCircle: import_prop_types8.default.bool,
  /**
   * Sets image shape as thumbnail.
   */
  thumbnail: import_prop_types8.default.bool
};
var Image2 = React57.forwardRef(({
  bsPrefix,
  className,
  fluid = false,
  rounded = false,
  ...
  return (0, import_jsx_runtime53.jsx)("img", {
...
var FigureImage = React58.forwardRef(({
  className,
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime54.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime55.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime55.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime55.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime55.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
});
var InputGroup = React59.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
  ...
  return (0, import_jsx_runtime55.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime55.jsx)(Component2, {
      ref,
      ...props,
...
var TabContext = React60.createContext(null);
...
var NavItem = React61.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
  ...
  return (0, import_jsx_runtime56.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React62.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  return (0, import_jsx_runtime57.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime57.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime57.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var ListGroupItem = React63.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, {
    ...
    ...navItemProps,
    onClick: handleClick,
    className: (0, import_classnames38.default)(className, bsPrefix, meta.isActive && "active", disabled && "disabled", variant && `${bsPrefix}-${variant}`, action && `${bsPrefix}-action`)
  });
});
...
var ListGroup = React64.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime59.jsx)(Nav_default, {
    ...
    ...controlledProps,
    as,
    className: (0, import_classnames39.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, numbered && `${bsPrefix}-numbered`)
  });
});
...
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime60.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
    return (0, import_jsx_runtime60.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime60.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react61.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime61.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime61.jsx)("div", Object.assign({}, dialogProps, {
    children: React66.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime61.jsx)(import_jsx_runtime62.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime63.jsxs)(import_jsx_runtime62.Fragment, {
...
var ModalContext = React67.createContext({
...
var ModalDialog = React68.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
  ...
  return (0, import_jsx_runtime64.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames40.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime64.jsx)("div", {
      className: (0, import_classnames40.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var AbstractModalHeader = React69.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React70.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime67.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime68.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React71.forwardRef(({
  ...
  const renderBackdrop = (0, import_react63.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames42.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime68.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    style: baseModalStyle,
    className: (0, import_classnames42.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    onClick: backdrop ? handleClick : void 0,
    onMouseUp: handleMouseUp,
    "aria-label": ariaLabel,
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime68.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime68.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime68.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavLink = React72.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React73.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  return (0, import_jsx_runtime70.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarBrand = React74.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React75.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime72.jsx)(Collapse_default, {
...
var NavbarToggle = React76.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasToggling = React77.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime74.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React77.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames47.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React78.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime76.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React79.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react69.useCallback)((backdropProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames49.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames49.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime77.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime76.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React80.forwardRef((props, ref) => {
  const context5 = (0, import_react70.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime79.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React81.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  return (0, import_jsx_runtime80.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React82.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime82.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames51.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime81.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React83.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var Popover = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsxs)("div", {
    ...
    className: (0, import_classnames52.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Tooltip = React86.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime86.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames53.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react74.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React87.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime87.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React87.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames54.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React88.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime90.jsxs)(import_jsx_runtime89.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react76.cloneElement)(children, triggerProps), (0, import_jsx_runtime88.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React89.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime91.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames55.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime92.jsxs)(Component2, {
      className: (0, import_classnames55.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
function createButton(name, defaultValue, label = name) {
  const Button = React89.forwardRef(({
    children,
    ...props
...
var Pagination = React90.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime93.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames56.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames57.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React91.forwardRef((props, ref) => {
...
var Placeholder = React92.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime96.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames58.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var ProgressBar = React93.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React94.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)("div", {
    ...
    className: (0, import_classnames59.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React94.Children.only(children)
  });
});
...
var Row = React95.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames60.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React96.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var propTypes6 = {
   ...
   */
  toggleLabel: import_prop_types9.default.string,
  ...
  align: alignPropType,
  /** An ARIA accessible role applied to the Menu component. When set to 'menu', The dropdown */
  menuRole: import_prop_types9.default.string,
  /** Whether to render the dropdown menu in the DOM before the first time it is shown */
  renderMenuOnMount: import_prop_types9.default.bool,
  /**
   *  Which event when fired outside the component will cause it to be closed.
   *
   * _see [DropdownMenu](#dropdown-menu-props) for more details_
   */
  rootCloseEvent: import_prop_types9.default.string,
  /**
   * Allow Dropdown to flip in case of an overlapping on the reference element. For more information refer to
   * Popper.js's flip [docs](https://popper.js.org/docs/v2/modifiers/flip/).
   *
   */
  flip: import_prop_types9.default.bool,
  /** @ignore */
  bsPrefix: import_prop_types9.default.string,
  /** @ignore */
  variant: import_prop_types9.default.string,
  /** @ignore */
  size: import_prop_types9.default.string
};
var SplitButton = React97.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  children: [(0, import_jsx_runtime100.jsx)(Button_default2, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime100.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime100.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react78.useContext)(TabContext_default);
  if (!context5)
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context5, rest = _objectWithoutPropertiesLoose9(context5, _excluded22);
...
var TabPanel = React99.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabPane = React102.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime106.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime106.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime106.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime106.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames63.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var propTypes7 = {
  eventKey: import_prop_types11.default.oneOfType([import_prop_types11.default.string, import_prop_types11.default.number]),
  /**
   * Content for the tab title.
   */
  title: import_prop_types11.default.node.isRequired,
  /**
   ...
   */
  tabClassName: import_prop_types11.default.string,
  /**
   * Object containing attributes to pass to underlying nav link.
   */
  tabAttrs: import_prop_types11.default.object
};
var Tab = () => {
  throw new Error("ReactBootstrap: The `Tab` component is not meant to be rendered! It's an abstract component that is only valid as a direct Child of the `Tabs` Component. For custom tabs components use TabPane and TabsContainer directly");
  return (0, import_jsx_runtime108.jsx)(import_jsx_runtime107.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime110.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime110.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime111.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime110.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime110.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime110.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React106.forwardRef((props, ref) => (0, import_jsx_runtime112.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React107.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React108.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context5 = (0, import_react80.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime114.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime113.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastContainer = React110.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React111.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime119.jsxs)(import_jsx_runtime118.Fragment, {
    children: [(0, import_jsx_runtime117.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames68.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React112.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
